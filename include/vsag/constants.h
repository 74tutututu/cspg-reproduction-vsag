...
extern const char* const HGRAPH_CSPG_PARTITION_GRAPH_TYPE;
...
extern const char* const HGRAPH_PARAMETER_CSPG_PHASE1_SKIP_BASE_DESCENT;
...
extern const char* const HGRAPH_PARAMETER_CSPG_MAX_ROUTING_FANOUT;
